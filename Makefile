...
TEST_NAME = run_test
SRC_MAIN  = main.cpp
TEST_FILES = main_test.cpp board.cpp extract_pattern.cpp game_rules.cpp
...
CXXFLAGS  = -Wall -Wextra --std=c++17 -Weffc++ -I${GTEST}/googletest/include -I${GTEST}/googletest -I$(SDL2_TTF) -I$(SDL2_IMAGE) -I/usr/include/SDL2 -Ofast -g -pg
SDL2_TTF  = libs/SDL2_ttf
SDL2_IMAGE = libs/SDL2_image
GTEST     = libs/gtest
LDFLAGS   = -lSDL2 -L$(SDL2_TTF)/build -lSDL2_ttf -L$(SDL2_IMAGE)/build -lSDL2_image -Wl,-rpath,$(SDL2_TTF)/build -Wl,-rpath,$(SDL2_IMAGE)/build -Ofast -g -pg
